...
type HoverTone = "peach" | "butter" | "mint" | "sky" | "rose";
...
const navItems: Array<{
  ...
  { label: "品牌故事", href: "#story", icon: Heart, accent: "bg-[#ffe7df] text-[#f2a08b]", tone: "peach" },
  { label: "核心能力", href: "#capabilities", icon: Sparkles, accent: "bg-[#fff0d5] text-[#e1aa55]", tone: "butter" },
  { label: "今日推荐", href: "#looks", icon: SunMedium, accent: "bg-[#eef7f1] text-[#89b79a]", tone: "mint" },
  { label: "风格探索", href: "#style", icon: Shirt, accent: "bg-[#edf2ff] text-[#8ea4d6]", tone: "sky" },
  { label: "常见问题", href: "#faq", icon: Star, accent: "bg-[#ffeef3] text-[#ea8ba3]", tone: "rose" }
];
...
const hoverOrnamentStyles = {
  peach: {
    glow: "from-[#ffd9cf]/0 via-[#ffd9cf]/80 to-[#fff8f2]/0",
    ring: "border-[#ffd7ca]/90 bg-[#fff7f2]/90",
    dot: "bg-[#f2a088]"
  },
  butter: {
    glow: "from-[#ffe7b5]/0 via-[#ffe7b5]/82 to-[#fffaf1]/0",
    ring: "border-[#f4deb0]/90 bg-[#fffaf0]/90",
    dot: "bg-[#e1ae59]"
  },
  mint: {
    glow: "from-[#d8eee3]/0 via-[#d8eee3]/82 to-[#f7fcfa]/0",
    ring: "border-[#cae6d6]/90 bg-[#f6fbf8]/90",
    dot: "bg-[#87b69b]"
  },
  sky: {
    glow: "from-[#dfe8ff]/0 via-[#dfe8ff]/84 to-[#f8faff]/0",
    ring: "border-[#d5e0ff]/90 bg-[#f6f8ff]/90",
    dot: "bg-[#8ea4d6]"
  },
  rose: {
    glow: "from-[#ffe1ea]/0 via-[#ffe1ea]/84 to-[#fff8fb]/0",
    ring: "border-[#ffd4e1]/90 bg-[#fff8fb]/90",
    dot: "bg-[#ea8ba3]"
  }
} as const;

function OptionHoverOrnament({ tone }: { tone: HoverTone }) {
  const palette = hoverOrnamentStyles[tone];

  return (
    <>
      <span
        aria-hidden="true"
        className={`pointer-events-none absolute right-2 top-1/2 h-10 w-16 -translate-y-1/2 rounded-full bg-gradient-to-r ${palette.glow} opacity-0 blur-xl transition duration-500 group-hover:opacity-100`}
      />
      <span
        aria-hidden="true"
        className={`pointer-events-none absolute right-3 top-2 size-5 rounded-full border ${palette.ring} opacity-0 shadow-[0_10px_24px_rgba(148,113,95,0.1)] transition duration-300 group-hover:translate-y-[2px] group-hover:opacity-100`}
      />
      <span
        aria-hidden="true"
        className={`pointer-events-none absolute bottom-2 right-8 size-2 rounded-full ${palette.dot} opacity-0 transition duration-300 delay-75 group-hover:-translate-y-1 group-hover:opacity-100`}
      />
      <span
        aria-hidden="true"
        className={`pointer-events-none absolute right-6 top-3 size-2 rounded-full ${palette.dot} opacity-0 transition duration-300 delay-100 group-hover:translate-y-[3px] group-hover:opacity-100`}
      />
    </>
  );
}
  ...
  return (
    <header className="relative z-20 mx-auto w-full max-w-7xl px-4 pt-5 md:px-6 lg:px-8">
      <motion.div
        ...
        className="flex items-center justify-between gap-4 rounded-full border border-white/70 bg-white/62 px-4 py-3 shadow-[0_24px_54px_rgba(148,113,95,0.12)] backdrop-blur-xl md:px-6"
      >
        <Link href="/" className="flex min-w-0 items-center gap-3">
          ...
          <span className="min-w-0">
            <strong style={displayStyle} className="block truncate text-[1.65rem] leading-none text-[var(--ink-strong)]">
              AI 衣橱
            </strong>
            <span style={labelStyle} className="block truncate pt-1 text-[11px] tracking-[0.26em] text-[var(--muted)]">
        ...
        <nav className="hidden items-center gap-2 lg:flex">
          {navItems.map((item) => {
            ...
            return (
              <motion.div key={item.href} whileHover={{ y: -2, scale: 1.01 }} transition={{ duration: 0.18 }}>
                <Link
                  href={item.href}
                  data-cute="true"
                  className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full border border-white/82 bg-white/68 px-4 py-2.5 text-[14px] tracking-[0.01em] text-[var(--muted)] shadow-[0_12px_28px_rgba(148,113,95,0.06)] transition hover:bg-white/88 hover:text-[var(--ink-strong)]"
                >
                  <OptionHoverOrnament tone={item.tone} />
                  <span className={`flex size-6 items-center justify-center rounded-full ${item.accent}`}>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/assistant"
            data-cute="true"
            className="group relative hidden overflow-hidden rounded-full border border-white/80 bg-white/75 px-4 py-2.5 text-sm text-[var(--ink)] shadow-[0_14px_32px_rgba(148,113,95,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_20px_42px_rgba(148,113,95,0.12)] md:inline-flex"
          >
            <OptionHoverOrnament tone="sky" />
            看看助手
          </Link>
          <Link
            href="/wardrobe"
            data-cute="true"
            className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full border border-white/80 bg-[linear-gradient(135deg,#ffd9cc_0%,#fff6ef_46%,#def4e8_100%)] px-4 py-2.5 text-sm text-[var(--ink-strong)] shadow-[0_18px_36px_rgba(148,113,95,0.12)] transition hover:-translate-y-0.5 hover:scale-[1.01] hover:shadow-[0_24px_44px_rgba(148,113,95,0.16)]"
          >
            <OptionHoverOrnament tone="mint" />
            开始整理
  ...
  return (
    <Reveal className="relative" delay={0.1}>
      <motion.div
        ...
        className="group relative overflow-hidden rounded-[42px] border border-white/70 bg-white/55 p-4 shadow-[0_40px_120px_rgba(165,118,104,0.24)] backdrop-blur-xl"
      >
        <div
        ...
        <div className="relative aspect-[5/6] overflow-hidden rounded-[32px] border border-white/80 bg-[#f9e4dc] shadow-[inset_0_1px_0_rgba(255,255,255,0.85)]">
          ...
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0)_32%,rgba(63,40,27,0.14))]" />

          <div className="absolute left-4 top-4">
            <span className="rounded-full border border-white/80 bg-white/80 px-3 py-1.5 text-[10px] text-[var(--ink)] shadow-[0_12px_26px_rgba(148,113,95,0.1)] backdrop-blur-md">
              柔粉房间 / 衣橱电影感 / 晨光
            </span>
          </div>
          ...
          <div className="absolute inset-x-5 bottom-5 flex items-end justify-between gap-4">
            <div className="max-w-[70%] rounded-[24px] border border-white/75 bg-white/76 px-4 py-3 shadow-[0_18px_40px_rgba(148,113,95,0.14)] backdrop-blur-md">
              <p style={labelStyle} className="text-[10px] uppercase tracking-[0.24em] text-[var(--muted)]">AI Wardrobe Film</p>
              <p className="mt-1 text-[13px] leading-6 text-[var(--ink)]">像生活方式品牌广告一样，先把“今天想穿什么”的感觉拍出来。</p>
            </div>

            <motion.div
              whileHover={{ scale: 1.04 }}
              className="flex size-16 items-center justify-center rounded-full border border-white/80 bg-white/82 shadow-[0_22px_44px_rgba(148,113,95,0.18)] backdrop-blur-md"
            >
        ...
        <div className="relative mt-4 grid gap-3 md:grid-cols-3">
          {[
            ...
            <motion.div
              ...
              className="rounded-[24px] border border-white/70 bg-white/70 p-4 shadow-[0_18px_36px_rgba(148,113,95,0.1)] backdrop-blur-md"
            >
      ...
      <Reveal className="relative">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/wardrobe"
            data-cute="true"
            className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-[linear-gradient(135deg,#ffd8cb_0%,#fff7ef_44%,#def4e8_100%)] px-6 py-3.5 text-sm font-medium text-[var(--ink-strong)] shadow-[0_20px_44px_rgba(148,113,95,0.12)] transition hover:-translate-y-1 hover:scale-[1.01] hover:shadow-[0_28px_52px_rgba(148,113,95,0.16)]"
          >
            开始整理衣橱
            <ArrowRight className="size-4" />
          </Link>
          <Link
            href="/recommend"
            data-cute="true"
            className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/76 px-6 py-3.5 text-sm font-medium text-[var(--ink)] shadow-[0_16px_34px_rgba(148,113,95,0.08)] transition hover:-translate-y-1 hover:scale-[1.01] hover:shadow-[0_24px_44px_rgba(148,113,95,0.12)]"
          >
            看今日穿搭推荐
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          {softMoments.map((item, index) => (
            <motion.div
              ...
              className="rounded-[28px] border border-white/80 bg-white/72 p-5 shadow-[0_22px_48px_rgba(148,113,95,0.1)] backdrop-blur-md"
            >
        ...
        {storyCards.map(({ eyebrow, title, description, icon: Icon, accent, chips }, index) => (
          <Reveal key={title} delay={index * 0.08}>
            <motion.article
              ...
              className={`h-full rounded-[32px] border border-white/80 bg-gradient-to-br ${accent} p-6 shadow-[0_24px_54px_rgba(148,113,95,0.12)]`}
            >
        ...
        {capabilityCards.map(({ title, description, icon: Icon, badge, accent, notes }, index) => (
          <Reveal key={title} delay={index * 0.06}>
            <motion.article
              ...
              className={`rounded-[32px] border border-white/80 bg-gradient-to-br ${accent} p-6 shadow-[0_22px_52px_rgba(148,113,95,0.1)]`}
            >
    ...
    <section id="looks" className="grid gap-5 lg:grid-cols-[1.12fr_0.88fr]">
      <Reveal className="rounded-[38px] border border-white/75 bg-white/60 p-6 shadow-[0_28px_60px_rgba(148,113,95,0.12)] backdrop-blur-xl md:p-8">
        ...
        <motion.article
          data-cute="true"
          whileHover={{ y: -6 }}
          className={`mt-8 overflow-hidden rounded-[34px] border border-white/80 bg-gradient-to-br ${lookCards[0].accent} p-5 shadow-[0_24px_54px_rgba(148,113,95,0.12)] md:p-6`}
        >
          <div className="grid gap-5 md:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="flex flex-col justify-between">
              ...
              <Link
                href="/recommend"
                className="mt-6 inline-flex items-center gap-2 self-start rounded-full border border-white/80 bg-white/78 px-5 py-3 text-sm font-medium text-[var(--ink-strong)] shadow-[0_16px_34px_rgba(148,113,95,0.08)] transition hover:-translate-y-1 hover:shadow-[0_22px_42px_rgba(148,113,95,0.12)]"
              >
                去看完整推荐池
                <ArrowRight className="size-4" />
              </Link>
      ...
      <div className="grid gap-4">
        {lookCards.slice(1).map((card, index) => (
          <Reveal key={card.title} delay={index * 0.08}>
            <motion.article
              data-cute="true"
              whileHover={{ y: -6, rotate: index % 2 === 0 ? 0.5 : -0.5 }}
              className={`rounded-[32px] border border-white/80 bg-gradient-to-br ${card.accent} p-5 shadow-[0_22px_48px_rgba(148,113,95,0.1)]`}
            >
        ...
        <Reveal delay={0.16}>
          <motion.div
            data-cute="true"
            whileHover={{ y: -5 }}
            className="rounded-[32px] border border-white/80 bg-[linear-gradient(135deg,rgba(255,244,237,0.92),rgba(255,255,255,0.78),rgba(236,247,240,0.86))] p-6 shadow-[0_22px_48px_rgba(148,113,95,0.1)]"
          >
            <p style={labelStyle} className="text-[10px] uppercase tracking-[0.24em] text-[var(--muted)]">
              SMALL REMINDER
            </p>
        ...
        <div className="flex flex-wrap gap-3">
          {styleTags.map((tag, index) => (
            <motion.button
              ...
              className="rounded-full border border-white/80 bg-white/78 px-4 py-3 text-sm text-[var(--ink)] shadow-[0_16px_34px_rgba(148,113,95,0.08)] backdrop-blur-md transition"
            >
              {tag}
            </motion.button>
          ))}
        ...
        {flowSteps.map(({ step, title, description, icon: Icon }, index) => (
          <Reveal key={step} delay={index * 0.06}>
            <motion.article
              data-cute="true"
              whileHover={{ y: -7, rotate: index % 2 === 0 ? -0.5 : 0.5 }}
              className="h-full rounded-[30px] border border-white/80 bg-white/78 p-5 shadow-[0_20px_44px_rgba(148,113,95,0.1)]"
            >
        ...
        {faqs.map(({ question, answer }, index) => (
          <Reveal key={question} delay={index * 0.04}>
            <motion.article
              data-cute="true"
              whileHover={{ y: -6 }}
              className="h-full rounded-[28px] border border-white/80 bg-white/78 p-5 shadow-[0_20px_44px_rgba(148,113,95,0.08)]"
            >
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/wardrobe"
                className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-[linear-gradient(135deg,#ffd8cb_0%,#fff7ef_42%,#def4e8_100%)] px-6 py-3.5 text-sm font-medium text-[var(--ink-strong)] shadow-[0_20px_44px_rgba(148,113,95,0.12)] transition hover:-translate-y-1 hover:scale-[1.01]"
              >
                开始整理真实衣橱
                <ArrowRight className="size-4" />
              </Link>
              <Link
                href="/assistant"
                className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/80 px-6 py-3.5 text-sm font-medium text-[var(--ink)] shadow-[0_16px_34px_rgba(148,113,95,0.08)] transition hover:-translate-y-1 hover:scale-[1.01]"
              >
                去看 AI 助手
