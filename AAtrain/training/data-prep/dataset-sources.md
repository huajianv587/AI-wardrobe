...
This `AAtrain/` copy is the one that travels to the cloud box with the real datasets, raw-source payloads, exports, and runbooks.
...
- Password required: no
- Owning entrypoint: `training/lora-finetune/run-5090-full-stack.generated.sh`
